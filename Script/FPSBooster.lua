--[[
  This Script Is Open Source, Script Helps Reduce Game Lag And Optimize Game.
  Script By: Nguyễn Minh Nhật (Discord: nguyenminhnhat.dino)
]]
...
StarterGui:SetCore("SendNotification", {
    Title = "APPLE HUB",
    Text = "Please Join My Discord Server",
    Duration = 10,
    Button1 = "Copy Link Invite",
    Callback = function(buttonPressed)
        if buttonPressed == "Button1" then
            setclipboard("https://discord.gg/cJN9jfnVRa")
